<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="duyurular.aspx.cs" Inherits="duyurular" %>
            ...
            <asp:DataList ID="DataList1" runat="server">
                <ItemTemplate>
                    ...
                    <div class="duyururesim">
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("duyuruResim") %>' Width="100%" Height="100%" />
                    </div>
                    <div class="duyurutarih">
                        <asp:Label ID="Label2" runat="server" Text='<%# string.Format("{0:d MMM yyyy}", Eval("duyuruTarih"))%>'></asp:Label>
                    </div>
                    <div class="duyuruicerik">
                        <asp:Label ID="Label3" runat="server" Text='<%# Eval("duyuruAciklama") %>'></asp:Label>
                    </div>
                </ItemTemplate>
            </asp:DataList>
