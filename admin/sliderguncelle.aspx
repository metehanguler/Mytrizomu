<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sliderguncelle.aspx.cs" Inherits="admin_sliderguncelle" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Label ID="Label1" runat="server" Text="Label"> <h1>Slider Düzenle</h1></asp:Label>
